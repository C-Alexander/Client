...
class PlayingScreen extends ScreenAdapter {
    ...
    private void loadOwnTeam(){
        ...
        Character character2 = new Character(new Race("Test", new Stats()), new Rank(RankName.GRUNT), assetManager, ClassEnum.AXE, new Vector2(12, 2));
        character2.setWeapon(new Weapon("Axe", 1, new Stats(), false, null));
        map.addCharacter(character2);
        Character character3 = new Character(new Race("Test", new Stats()),new Rank(RankName.GRUNT), assetManager, ClassEnum.AXE, new Vector2(14,2));
        character1.setWeapon(new Weapon("Axe",1,new Stats(),false,null));
        map.addCharacter(character3);
        Character character4 = new Character(new Race("Test", new Stats()),new Rank(RankName.GENERAL), assetManager, ClassEnum.SWORD,new Vector2(15,5));
        character1.setWeapon(new Weapon("Axe",1,new Stats(),false,null));
        map.addCharacter(character4);
        Character character5 = new Character(new Race("Test", new Stats()),new Rank(RankName.GRUNT), assetManager, ClassEnum.SWORD, new Vector2(14,4));
        character1.setWeapon(new Weapon("Axe",1,new Stats(),false,null));
        map.addCharacter(character5);
        Character character6 = new Character(new Race("Test", new Stats()), new Rank(RankName.GRUNT),assetManager, ClassEnum.SWORD, new Vector2(16,4));
        character1.setWeapon(new Weapon("Axe",1,new Stats(),false,null));
        map.addCharacter(character6);
        Character character7 = new Character(new Race("Test", new Stats()), new Rank(RankName.HERO),assetManager, ClassEnum.VALKYRIE, new Vector2(15, 3));
        character2.setWeapon(new Weapon("Axe", 1, new Stats(), false, null));
        map.addCharacter(character7);
        Character character8 = new Character(new Race("Test", new Stats()),new Rank(RankName.GENERAL), assetManager, ClassEnum.ARCHER, new Vector2(17,3));
        character1.setWeapon(new Weapon("Axe",1,new Stats(),false,null));
        map.addCharacter(character8);
        Character character9 = new Character(new Race("Test", new Stats()),new Rank(RankName.GRUNT), assetManager, ClassEnum.ARCHER, new Vector2(16,2));
        character1.setWeapon(new Weapon("Axe",1,new Stats(),false,null));
