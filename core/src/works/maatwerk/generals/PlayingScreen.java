...
class PlayingScreen extends ScreenAdapter {
    ...
    private void loadOwnTeam(){
        ...
        Character character8 = new Character(new Race("Test", new Stats()),new Rank(RankName.GENERAL), WeaponClass.ARCHER, assetManager, new Vector2(17,3));
        character1.setWeapon(new Weapon("Axe",1,new Stats(),false,null));
        map.addCharacter(character8);
        Character character9 = new Character(new Race("Test", new Stats()),new Rank(RankName.GRUNT), WeaponClass.ARCHER, assetManager, new Vector2(16,2));
        character1.setWeapon(new Weapon("Axe",1,new Stats(),false,null));
        map.addCharacter(character9);
        Character character10 = new Character(new Race("Test", new Stats()), new Rank(RankName.GRUNT), WeaponClass.ARCHER, assetManager, new Vector2(18,2));
        character1.setWeapon(new Weapon("Axe",1,new Stats(),false,null));
