...
public class Character extends Actor {
     ...
     * @param location
     */
    public Character(Race race, Rank rank, int weaponclass, AssetManager assetManager, ClassEnum classEnum, Vector2 location) {
    ...
    public void matchStart() {
        ...
        while (minions.size() < MAX_MINIONS) {
            minions.add(new Character(race, new Rank(RankName.GRUNT), this.weaponClass, this.assetManager, this.classEnum, this.location));
        }
    }
