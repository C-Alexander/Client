...
public class Character extends Actor {
    ...
    public void attack(Character enemy) {
        ...
        int damageToEnemy = calculateDamage(((weapon == null) ? false : weapon.isCanHeal()), enemyStats, ownStats);
        int damageToSelf = calculateDamage(((enemy.weapon == null) ? false : enemy.weapon.isCanHeal()), ownStats, enemyStats);
